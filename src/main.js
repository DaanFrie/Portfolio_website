...
function generateProjectDetailHTML(project) {
    ...
    const heroMedia = project.id === 3
        ...
        <div class="mb-[6vw] md:mb-[4vh] fade-in">
          <video controls poster="images/showcase/FPSparkour/fpsparcourgame1.png" class="w-full h-auto rounded-[1vw] md:rounded-[1vh] shadow-lg max-w-[80vw] mx-auto md:max-w-[40vw]">
